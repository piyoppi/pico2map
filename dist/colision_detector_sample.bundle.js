...
/***/ "../tiled-colision-detector/dist/TiledColisionDetector.js":
/*!****************************************************************!*\
  !*** ../tiled-colision-detector/dist/TiledColisionDetector.js ***!
  \****************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
class TiledColisionDetector {
    ...
    getOverlapped(item) {
        ...
        if (colidedPositions.length === 0)
            return { ...overlapped, dx: 0, dy: 0 };
        ...
        if (overlapped.dx === this._chipWidth)
            overlapped.dx = 0;
        if (overlapped.dy === this._chipHeight)
            overlapped.dy = 0;
        return overlapped;
    }
    solveOverlapped(item, limit = 2) {
        const clonedItem = { ...item };
        for (let i = 0; i < limit; i++) {
            const overlapped = this.getOverlapped(clonedItem);
            if (overlapped.dx === 0 && overlapped.dy === 0)
                break;
...
//# sourceMappingURL=TiledColisionDetector.js.map

/***/ }),

/***/ "../tiled-colision-detector/dist/main.js":
/*!***********************************************!*\
  !*** ../tiled-colision-detector/dist/main.js ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
(() => {
/*!***********************************************************!*\
  !*** ./colision_detector/src/colision_detector_sample.ts ***!
  \***********************************************************/
__webpack_require__.r(__webpack_exports__);
...
/* harmony import */ var _piyoppi_pico2map_tiled__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @piyoppi/pico2map-tiled */ "../tiled-map/dist/main.js");
/* harmony import */ var _piyoppi_pico2map_tiled_colision_detector__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @piyoppi/pico2map-tiled-colision-detector */ "../tiled-colision-detector/dist/main.js");
 ...
 */
function updateDisplayedCharacter(x, y) {
...
async function initialize() {
    ...
    const tiledMap = _piyoppi_pico2map_tiled__WEBPACK_IMPORTED_MODULE_1__.TiledMap.fromObject(await serializedDataResponse.json());
    ...
    const detector = new _piyoppi_pico2map_tiled_colision_detector__WEBPACK_IMPORTED_MODULE_2__.TiledColisionDetector(tiledMap.coliders, chipSize.width, chipSize.height);
    const velocity = 3;
...
/******/ })()
;
//# sourceMappingURL=colision_detector_sample.bundle.js.map